...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.AbstractPodProps.parameter.automountServiceAccountToken"></a>
...
##### `scope`<sup>Required</sup> <a name="org.cdk8s.plus22.CronJob.parameter.scope"></a>
...
##### `select`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.parameter.select"></a>
...
##### `spread`<sup>Optional</sup> <a name="org.cdk8s.plus22.DaemonSetProps.parameter.spread"></a>
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.JobProps.parameter.automountServiceAccountToken"></a>
...
##### `select`<sup>Optional</sup> <a name="org.cdk8s.plus22.JobProps.parameter.select"></a>
...
##### `spread`<sup>Optional</sup> <a name="org.cdk8s.plus22.JobProps.parameter.spread"></a>
...
### Namespace <a name="org.cdk8s.plus22.Namespace"></a>

- *Implements:* [`org.cdk8s.plus22.INamespaceSelector`](#org.cdk8s.plus22.INamespaceSelector), [`org.cdk8s.plus22.INetworkPolicyPeer`](#org.cdk8s.plus22.INetworkPolicyPeer)
...
#### Initializers <a name="org.cdk8s.plus22.Namespace.Initializer"></a>

```java
import org.cdk8s.plus22.Namespace;
...
##### `scope`<sup>Required</sup> <a name="org.cdk8s.plus22.Namespace.parameter.scope"></a>

- *Type:* [`software.constructs.Construct`](#software.constructs.Construct)

---

##### `id`<sup>Required</sup> <a name="org.cdk8s.plus22.Namespace.parameter.id"></a>

- *Type:* `java.lang.String`

---

##### `metadata`<sup>Optional</sup> <a name="org.cdk8s.plus22.NamespaceProps.parameter.metadata"></a>
...
##### `toNamespaceSelectorConfig` <a name="org.cdk8s.plus22.Namespace.toNamespaceSelectorConfig"></a>

```java
public toNamespaceSelectorConfig()
```

##### `toNetworkPolicyPeerConfig` <a name="org.cdk8s.plus22.Namespace.toNetworkPolicyPeerConfig"></a>

```java
public toNetworkPolicyPeerConfig()
```

##### `toPodSelector` <a name="org.cdk8s.plus22.Namespace.toPodSelector"></a>
...
##### `resourceType`<sup>Required</sup> <a name="org.cdk8s.plus22.Namespace.property.resourceType"></a>
...
##### `NAME_LABEL` <a name="org.cdk8s.plus22.Namespace.property.NAME_LABEL"></a>
...
### Namespaces <a name="org.cdk8s.plus22.Namespaces"></a>

- *Implements:* [`org.cdk8s.plus22.INamespaceSelector`](#org.cdk8s.plus22.INamespaceSelector), [`org.cdk8s.plus22.INetworkPolicyPeer`](#org.cdk8s.plus22.INetworkPolicyPeer)

Represents a group of namespaces.

#### Initializers <a name="org.cdk8s.plus22.Namespaces.Initializer"></a>

```java
import org.cdk8s.plus22.Namespaces;
...
##### `scope`<sup>Required</sup> <a name="org.cdk8s.plus22.Namespaces.parameter.scope"></a>

- *Type:* [`software.constructs.Construct`](#software.constructs.Construct)

---

##### `id`<sup>Required</sup> <a name="org.cdk8s.plus22.Namespaces.parameter.id"></a>

- *Type:* `java.lang.String`

---

##### `expressions`<sup>Optional</sup> <a name="org.cdk8s.plus22.Namespaces.parameter.expressions"></a>

- *Type:* java.util.List<[`org.cdk8s.plus22.LabelExpression`](#org.cdk8s.plus22.LabelExpression)>

---

##### `names`<sup>Optional</sup> <a name="org.cdk8s.plus22.Namespaces.parameter.names"></a>

- *Type:* java.util.List<`java.lang.String`>

---

##### `labels`<sup>Optional</sup> <a name="org.cdk8s.plus22.Namespaces.parameter.labels"></a>
...
##### `toNamespaceSelectorConfig` <a name="org.cdk8s.plus22.Namespaces.toNamespaceSelectorConfig"></a>

```java
public toNamespaceSelectorConfig()
```

##### `toNetworkPolicyPeerConfig` <a name="org.cdk8s.plus22.Namespaces.toNetworkPolicyPeerConfig"></a>

```java
public toNetworkPolicyPeerConfig()
```

##### `toPodSelector` <a name="org.cdk8s.plus22.Namespaces.toPodSelector"></a>
...
##### `all` <a name="org.cdk8s.plus22.Namespaces.all"></a>
...
##### `select` <a name="org.cdk8s.plus22.Namespaces.select"></a>
...
###### `options`<sup>Required</sup> <a name="org.cdk8s.plus22.Namespaces.parameter.options"></a>

- *Type:* [`org.cdk8s.plus22.NamespacesSelectOptions`](#org.cdk8s.plus22.NamespacesSelectOptions)

---



### NetworkPolicy <a name="org.cdk8s.plus22.NetworkPolicy"></a>
...
#### Initializers <a name="org.cdk8s.plus22.NetworkPolicy.Initializer"></a>

```java
import org.cdk8s.plus22.NetworkPolicy;
...
##### `scope`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicy.parameter.scope"></a>

- *Type:* [`software.constructs.Construct`](#software.constructs.Construct)

---

##### `id`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicy.parameter.id"></a>

- *Type:* `java.lang.String`

---

##### `metadata`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyProps.parameter.metadata"></a>
...
##### `egress`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyProps.parameter.egress"></a>

- *Type:* [`org.cdk8s.plus22.NetworkPolicyTraffic`](#org.cdk8s.plus22.NetworkPolicyTraffic)
...
##### `ingress`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyProps.parameter.ingress"></a>
...
##### `selector`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyProps.parameter.selector"></a>

- *Type:* [`org.cdk8s.plus22.IPodSelector`](#org.cdk8s.plus22.IPodSelector)
...
##### `addEgressRule` <a name="org.cdk8s.plus22.NetworkPolicy.addEgressRule"></a>
...
###### `peer`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicy.parameter.peer"></a>

- *Type:* [`org.cdk8s.plus22.INetworkPolicyPeer`](#org.cdk8s.plus22.INetworkPolicyPeer)

---

###### `ports`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicy.parameter.ports"></a>

- *Type:* java.util.List<[`org.cdk8s.plus22.NetworkPolicyPort`](#org.cdk8s.plus22.NetworkPolicyPort)>

---

##### `addIngressRule` <a name="org.cdk8s.plus22.NetworkPolicy.addIngressRule"></a>
...
##### `resourceType`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicy.property.resourceType"></a>
...
### NetworkPolicyIpBlock <a name="org.cdk8s.plus22.NetworkPolicyIpBlock"></a>

- *Implements:* [`org.cdk8s.plus22.INetworkPolicyPeer`](#org.cdk8s.plus22.INetworkPolicyPeer)
...
##### `toNetworkPolicyPeerConfig` <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.toNetworkPolicyPeerConfig"></a>

```java
public toNetworkPolicyPeerConfig()
```

##### `toPodSelector` <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.toPodSelector"></a>
...
##### `anyIpv4` <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.anyIpv4"></a>

```java
import org.cdk8s.plus22.NetworkPolicyIpBlock;

NetworkPolicyIpBlock.anyIpv4(Construct scope, java.lang.String id)
```

###### `scope`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.parameter.scope"></a>

- *Type:* [`software.constructs.Construct`](#software.constructs.Construct)

---

###### `id`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.parameter.id"></a>

- *Type:* `java.lang.String`

---

##### `anyIpv6` <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.anyIpv6"></a>
...
##### `ipv4` <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.ipv4"></a>
...
###### `cidrIp`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.parameter.cidrIp"></a>

- *Type:* `java.lang.String`

---

###### `except`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.parameter.except"></a>

- *Type:* java.util.List<`java.lang.String`>

---

##### `ipv6` <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.ipv6"></a>
...
##### `cidr`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.property.cidr"></a>
...
##### `except`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyIpBlock.property.except"></a>
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodProps.parameter.automountServiceAccountToken"></a>
...
##### `connections`<sup>Required</sup> <a name="org.cdk8s.plus22.Pod.property.connections"></a>

```java
public PodConnections getConnections();
```

- *Type:* [`org.cdk8s.plus22.PodConnections`](#org.cdk8s.plus22.PodConnections)

---

##### `podMetadata`<sup>Required</sup> <a name="org.cdk8s.plus22.Pod.property.podMetadata"></a>
...
##### `scheduling`<sup>Required</sup> <a name="org.cdk8s.plus22.Pod.property.scheduling"></a>

```java
public PodScheduling getScheduling();
```

- *Type:* [`org.cdk8s.plus22.PodScheduling`](#org.cdk8s.plus22.PodScheduling)

---

#### Constants <a name="Constants"></a>

##### `ADDRESS_LABEL` <a name="org.cdk8s.plus22.Pod.property.ADDRESS_LABEL"></a>
...
### Pods <a name="org.cdk8s.plus22.Pods"></a>

- *Implements:* [`org.cdk8s.plus22.IPodSelector`](#org.cdk8s.plus22.IPodSelector)

Represents a group of pods.

#### Initializers <a name="org.cdk8s.plus22.Pods.Initializer"></a>

```java
import org.cdk8s.plus22.Pods;
...
##### `scope`<sup>Required</sup> <a name="org.cdk8s.plus22.Pods.parameter.scope"></a>

- *Type:* [`software.constructs.Construct`](#software.constructs.Construct)

---

##### `id`<sup>Required</sup> <a name="org.cdk8s.plus22.Pods.parameter.id"></a>

- *Type:* `java.lang.String`

---

##### `expressions`<sup>Optional</sup> <a name="org.cdk8s.plus22.Pods.parameter.expressions"></a>

- *Type:* java.util.List<[`org.cdk8s.plus22.LabelExpression`](#org.cdk8s.plus22.LabelExpression)>

---

##### `labels`<sup>Optional</sup> <a name="org.cdk8s.plus22.Pods.parameter.labels"></a>

- *Type:* java.util.Map<java.lang.String, `java.lang.String`>

---

##### `namespaces`<sup>Optional</sup> <a name="org.cdk8s.plus22.Pods.parameter.namespaces"></a>

- *Type:* [`org.cdk8s.plus22.INamespaceSelector`](#org.cdk8s.plus22.INamespaceSelector)

---

#### Methods <a name="Methods"></a>

##### `toNetworkPolicyPeerConfig` <a name="org.cdk8s.plus22.Pods.toNetworkPolicyPeerConfig"></a>

```java
public toNetworkPolicyPeerConfig()
```

##### `toPodSelector` <a name="org.cdk8s.plus22.Pods.toPodSelector"></a>

```java
public toPodSelector()
```

##### `toPodSelectorConfig` <a name="org.cdk8s.plus22.Pods.toPodSelectorConfig"></a>
...
##### `all` <a name="org.cdk8s.plus22.Pods.all"></a>
...
###### `options`<sup>Optional</sup> <a name="org.cdk8s.plus22.Pods.parameter.options"></a>

- *Type:* [`org.cdk8s.plus22.PodsAllOptions`](#org.cdk8s.plus22.PodsAllOptions)

---

##### `select` <a name="org.cdk8s.plus22.Pods.select"></a>
...
###### `options`<sup>Required</sup> <a name="org.cdk8s.plus22.Pods.parameter.options"></a>

- *Type:* [`org.cdk8s.plus22.PodsSelectOptions`](#org.cdk8s.plus22.PodsSelectOptions)
...
- *Implements:* [`org.cdk8s.plus22.IResource`](#org.cdk8s.plus22.IResource), [`org.cdk8s.plus22.IApiResource`](#org.cdk8s.plus22.IApiResource), [`org.cdk8s.plus22.IApiEndpoint`](#org.cdk8s.plus22.IApiEndpoint)
...
##### `asApiResource` <a name="org.cdk8s.plus22.Resource.asApiResource"></a>

```java
public asApiResource()
```

##### `asNonApiResource` <a name="org.cdk8s.plus22.Resource.asNonApiResource"></a>
...
##### `permissions`<sup>Required</sup> <a name="org.cdk8s.plus22.Resource.property.permissions"></a>

```java
public ResourcePermissions getPermissions();
```

- *Type:* [`org.cdk8s.plus22.ResourcePermissions`](#org.cdk8s.plus22.ResourcePermissions)
...
- *Type:* java.util.List<[`org.cdk8s.plus22.RolePolicyRule`](#org.cdk8s.plus22.RolePolicyRule)>
- *Default:* []
...
##### `fromRoleName` <a name="org.cdk8s.plus22.Role.fromRoleName"></a>
...
###### `name`<sup>Required</sup> <a name="org.cdk8s.plus22.Role.parameter.name"></a>
...
##### `selector`<sup>Optional</sup> <a name="org.cdk8s.plus22.ServiceProps.parameter.selector"></a>
...
##### `bind` <a name="org.cdk8s.plus22.Service.bind"></a>
...
- *Type:* [`org.cdk8s.plus22.ServiceBindOptions`](#org.cdk8s.plus22.ServiceBindOptions)
...
##### `select` <a name="org.cdk8s.plus22.Service.select"></a>

```java
public select(IPodSelector selector)
```

###### `selector`<sup>Required</sup> <a name="org.cdk8s.plus22.Service.parameter.selector"></a>

- *Type:* [`org.cdk8s.plus22.IPodSelector`](#org.cdk8s.plus22.IPodSelector)

---

##### `selectLabel` <a name="org.cdk8s.plus22.Service.selectLabel"></a>

```java
public selectLabel(java.lang.String key, java.lang.String value)
```

###### `key`<sup>Required</sup> <a name="org.cdk8s.plus22.Service.parameter.key"></a>
...
##### `automountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.ServiceAccountProps.parameter.automountToken"></a>
...
##### `toSubjectConfiguration` <a name="org.cdk8s.plus22.ServiceAccount.toSubjectConfiguration"></a>
...
##### `automountToken`<sup>Required</sup> <a name="org.cdk8s.plus22.ServiceAccount.property.automountToken"></a>
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.StatefulSetProps.parameter.automountServiceAccountToken"></a>
...
##### `select`<sup>Optional</sup> <a name="org.cdk8s.plus22.StatefulSetProps.parameter.select"></a>
...
##### `spread`<sup>Optional</sup> <a name="org.cdk8s.plus22.StatefulSetProps.parameter.spread"></a>
...
##### `minReady`<sup>Optional</sup> <a name="org.cdk8s.plus22.StatefulSetProps.parameter.minReady"></a>
...
##### `minReady`<sup>Required</sup> <a name="org.cdk8s.plus22.StatefulSet.property.minReady"></a>
...
##### `toSubjectConfiguration` <a name="org.cdk8s.plus22.User.toSubjectConfiguration"></a>
...
##### `fromName` <a name="org.cdk8s.plus22.User.fromName"></a>
...
###### `scope`<sup>Required</sup> <a name="org.cdk8s.plus22.User.parameter.scope"></a>

- *Type:* [`software.constructs.Construct`](#software.constructs.Construct)

---

###### `id`<sup>Required</sup> <a name="org.cdk8s.plus22.User.parameter.id"></a>

- *Type:* `java.lang.String`

---

###### `name`<sup>Required</sup> <a name="org.cdk8s.plus22.User.parameter.name"></a>
...
###### `scope`<sup>Required</sup> <a name="org.cdk8s.plus22.Volume.parameter.scope"></a>

- *Type:* [`software.constructs.Construct`](#software.constructs.Construct)

---

###### `id`<sup>Required</sup> <a name="org.cdk8s.plus22.Volume.parameter.id"></a>
...
##### `fromHostPath` <a name="org.cdk8s.plus22.Volume.fromHostPath"></a>
...
###### `options`<sup>Required</sup> <a name="org.cdk8s.plus22.Volume.parameter.options"></a>

- *Type:* [`org.cdk8s.plus22.HostPathVolumeOptions`](#org.cdk8s.plus22.HostPathVolumeOptions)
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadProps.parameter.automountServiceAccountToken"></a>
...
##### `dns`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadProps.parameter.dns"></a>
...
##### `dockerRegistryAuth`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadProps.parameter.dockerRegistryAuth"></a>
...
##### `select`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadProps.parameter.select"></a>
...
##### `spread`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadProps.parameter.spread"></a>
...
##### `select` <a name="org.cdk8s.plus22.Workload.select"></a>

```java
public select(LabelSelector selectors)
```

###### `selectors`<sup>Required</sup> <a name="org.cdk8s.plus22.Workload.parameter.selectors"></a>

- *Type:* [`org.cdk8s.plus22.LabelSelector`](#org.cdk8s.plus22.LabelSelector)
...
##### `connections`<sup>Required</sup> <a name="org.cdk8s.plus22.Workload.property.connections"></a>
...
##### `matchExpressions`<sup>Required</sup> <a name="org.cdk8s.plus22.Workload.property.matchExpressions"></a>

```java
public java.util.List<LabelSelectorRequirement> getMatchExpressions();
```

- *Type:* java.util.List<[`org.cdk8s.plus22.LabelSelectorRequirement`](#org.cdk8s.plus22.LabelSelectorRequirement)>
...
##### `matchLabels`<sup>Required</sup> <a name="org.cdk8s.plus22.Workload.property.matchLabels"></a>
...
##### `scheduling`<sup>Required</sup> <a name="org.cdk8s.plus22.Workload.property.scheduling"></a>

```java
public WorkloadScheduling getScheduling();
```

- *Type:* [`org.cdk8s.plus22.WorkloadScheduling`](#org.cdk8s.plus22.WorkloadScheduling)
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.AbstractPodProps.property.automountServiceAccountToken"></a>
...
##### `dns`<sup>Optional</sup> <a name="org.cdk8s.plus22.AbstractPodProps.property.dns"></a>
...
##### `dockerRegistryAuth`<sup>Optional</sup> <a name="org.cdk8s.plus22.AbstractPodProps.property.dockerRegistryAuth"></a>
...
### ClusterRolePolicyRule <a name="org.cdk8s.plus22.ClusterRolePolicyRule"></a>
...
```java
import org.cdk8s.plus22.ClusterRolePolicyRule;
...
##### `endpoints`<sup>Required</sup> <a name="org.cdk8s.plus22.ClusterRolePolicyRule.property.endpoints"></a>

```java
public java.util.List<IApiEndpoint> getEndpoints();
```

- *Type:* java.util.List<[`org.cdk8s.plus22.IApiEndpoint`](#org.cdk8s.plus22.IApiEndpoint)>
...
##### `verbs`<sup>Required</sup> <a name="org.cdk8s.plus22.ClusterRolePolicyRule.property.verbs"></a>
...
### ContainerPort <a name="org.cdk8s.plus22.ContainerPort"></a>
...
```java
import org.cdk8s.plus22.ContainerPort;
...
##### `number`<sup>Required</sup> <a name="org.cdk8s.plus22.ContainerPort.property.number"></a>
...
##### `hostIp`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerPort.property.hostIp"></a>
...
##### `hostPort`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerPort.property.hostPort"></a>
...
##### `name`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerPort.property.name"></a>
...
##### `protocol`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerPort.property.protocol"></a>
...
##### `envFrom`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerProps.property.envFrom"></a>

```java
public java.util.List<EnvFrom> getEnvFrom();
```

- *Type:* java.util.List<[`org.cdk8s.plus22.EnvFrom`](#org.cdk8s.plus22.EnvFrom)>
- *Default:* No sources.
...
##### `envVariables`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerProps.property.envVariables"></a>
...
##### `portNumber`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerProps.property.portNumber"></a>
...
##### `ports`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerProps.property.ports"></a>

```java
public java.util.List<ContainerPort> getPorts();
```

- *Type:* java.util.List<[`org.cdk8s.plus22.ContainerPort`](#org.cdk8s.plus22.ContainerPort)>
...
##### `cpu`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerResources.property.cpu"></a>
...
##### `ephemeralStorage`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerResources.property.ephemeralStorage"></a>

```java
public EphemeralStorageResources getEphemeralStorage();
```

- *Type:* [`org.cdk8s.plus22.EphemeralStorageResources`](#org.cdk8s.plus22.EphemeralStorageResources)

---

##### `memory`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerResources.property.memory"></a>
...
##### `allowPrivilegeEscalation`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerSecurityContextProps.property.allowPrivilegeEscalation"></a>
...
##### `limit`<sup>Optional</sup> <a name="org.cdk8s.plus22.CpuResources.property.limit"></a>
...
##### `request`<sup>Optional</sup> <a name="org.cdk8s.plus22.CpuResources.property.request"></a>
...
### CronJobProps <a name="org.cdk8s.plus22.CronJobProps"></a>
...
```java
import org.cdk8s.plus22.CronJobProps;
...
##### `metadata`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.metadata"></a>
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.automountServiceAccountToken"></a>
...
##### `containers`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.containers"></a>
...
##### `dns`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.dns"></a>
...
##### `dockerRegistryAuth`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.dockerRegistryAuth"></a>
...
##### `hostAliases`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.hostAliases"></a>
...
##### `initContainers`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.initContainers"></a>
...
##### `restartPolicy`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.restartPolicy"></a>
...
##### `securityContext`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.securityContext"></a>
...
##### `serviceAccount`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.serviceAccount"></a>
...
##### `volumes`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.volumes"></a>
...
##### `podMetadata`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.podMetadata"></a>
...
##### `select`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.select"></a>
...
##### `spread`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.spread"></a>
...
##### `activeDeadline`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.activeDeadline"></a>
...
##### `backoffLimit`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.backoffLimit"></a>
...
##### `ttlAfterFinished`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.ttlAfterFinished"></a>
...
##### `schedule`<sup>Required</sup> <a name="org.cdk8s.plus22.CronJobProps.property.schedule"></a>
...
##### `concurrencyPolicy`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.concurrencyPolicy"></a>
...
##### `failedJobsRetained`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.failedJobsRetained"></a>
...
##### `startingDeadline`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.startingDeadline"></a>
...
##### `successfulJobsRetained`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.successfulJobsRetained"></a>
...
##### `suspend`<sup>Optional</sup> <a name="org.cdk8s.plus22.CronJobProps.property.suspend"></a>
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.DaemonSetProps.property.automountServiceAccountToken"></a>
...
##### `select`<sup>Optional</sup> <a name="org.cdk8s.plus22.DaemonSetProps.property.select"></a>
...
##### `spread`<sup>Optional</sup> <a name="org.cdk8s.plus22.DaemonSetProps.property.spread"></a>
...
### DeploymentExposeViaServiceOptions <a name="org.cdk8s.plus22.DeploymentExposeViaServiceOptions"></a>
...
```java
import org.cdk8s.plus22.DeploymentExposeViaServiceOptions;
...
##### `name`<sup>Optional</sup> <a name="org.cdk8s.plus22.DeploymentExposeViaServiceOptions.property.name"></a>
...
##### `ports`<sup>Optional</sup> <a name="org.cdk8s.plus22.DeploymentExposeViaServiceOptions.property.ports"></a>
...
##### `serviceType`<sup>Optional</sup> <a name="org.cdk8s.plus22.DeploymentExposeViaServiceOptions.property.serviceType"></a>
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.DeploymentProps.property.automountServiceAccountToken"></a>
...
##### `select`<sup>Optional</sup> <a name="org.cdk8s.plus22.DeploymentProps.property.select"></a>
...
##### `spread`<sup>Optional</sup> <a name="org.cdk8s.plus22.DeploymentProps.property.spread"></a>
...
### EphemeralStorageResources <a name="org.cdk8s.plus22.EphemeralStorageResources"></a>
...
```java
import org.cdk8s.plus22.EphemeralStorageResources;
...
##### `limit`<sup>Optional</sup> <a name="org.cdk8s.plus22.EphemeralStorageResources.property.limit"></a>
...
##### `request`<sup>Optional</sup> <a name="org.cdk8s.plus22.EphemeralStorageResources.property.request"></a>
...
##### `ports`<sup>Optional</sup> <a name="org.cdk8s.plus22.ExposeDeploymentViaIngressOptions.property.ports"></a>
...
### HostPathVolumeOptions <a name="org.cdk8s.plus22.HostPathVolumeOptions"></a>
...
```java
import org.cdk8s.plus22.HostPathVolumeOptions;
...
##### `path`<sup>Required</sup> <a name="org.cdk8s.plus22.HostPathVolumeOptions.property.path"></a>
...
##### `type`<sup>Optional</sup> <a name="org.cdk8s.plus22.HostPathVolumeOptions.property.type"></a>

```java
public HostPathVolumeType getType();
```

- *Type:* [`org.cdk8s.plus22.HostPathVolumeType`](#org.cdk8s.plus22.HostPathVolumeType)
...
##### `scheme`<sup>Optional</sup> <a name="org.cdk8s.plus22.HttpGetProbeOptions.property.scheme"></a>

```java
public ConnectionScheme getScheme();
```

- *Type:* [`org.cdk8s.plus22.ConnectionScheme`](#org.cdk8s.plus22.ConnectionScheme)
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.JobProps.property.automountServiceAccountToken"></a>
...
##### `select`<sup>Optional</sup> <a name="org.cdk8s.plus22.JobProps.property.select"></a>
...
##### `spread`<sup>Optional</sup> <a name="org.cdk8s.plus22.JobProps.property.spread"></a>
...
### LabelSelectorOptions <a name="org.cdk8s.plus22.LabelSelectorOptions"></a>
...
```java
import org.cdk8s.plus22.LabelSelectorOptions;
...
##### `expressions`<sup>Optional</sup> <a name="org.cdk8s.plus22.LabelSelectorOptions.property.expressions"></a>
...
##### `labels`<sup>Optional</sup> <a name="org.cdk8s.plus22.LabelSelectorOptions.property.labels"></a>
...
### LabelSelectorRequirement <a name="org.cdk8s.plus22.LabelSelectorRequirement"></a>
...
```java
import org.cdk8s.plus22.LabelSelectorRequirement;
...
##### `key`<sup>Required</sup> <a name="org.cdk8s.plus22.LabelSelectorRequirement.property.key"></a>
...
##### `operator`<sup>Required</sup> <a name="org.cdk8s.plus22.LabelSelectorRequirement.property.operator"></a>
...
##### `values`<sup>Optional</sup> <a name="org.cdk8s.plus22.LabelSelectorRequirement.property.values"></a>
...
##### `limit`<sup>Optional</sup> <a name="org.cdk8s.plus22.MemoryResources.property.limit"></a>
...
##### `request`<sup>Optional</sup> <a name="org.cdk8s.plus22.MemoryResources.property.request"></a>
...
### NamespaceProps <a name="org.cdk8s.plus22.NamespaceProps"></a>
...
```java
import org.cdk8s.plus22.NamespaceProps;
...
##### `metadata`<sup>Optional</sup> <a name="org.cdk8s.plus22.NamespaceProps.property.metadata"></a>
...
### NamespaceSelectorConfig <a name="org.cdk8s.plus22.NamespaceSelectorConfig"></a>
...
```java
import org.cdk8s.plus22.NamespaceSelectorConfig;
...
##### `labelSelector`<sup>Optional</sup> <a name="org.cdk8s.plus22.NamespaceSelectorConfig.property.labelSelector"></a>
...
##### `names`<sup>Optional</sup> <a name="org.cdk8s.plus22.NamespaceSelectorConfig.property.names"></a>
...
### NamespacesSelectOptions <a name="org.cdk8s.plus22.NamespacesSelectOptions"></a>
...
```java
import org.cdk8s.plus22.NamespacesSelectOptions;
...
##### `expressions`<sup>Optional</sup> <a name="org.cdk8s.plus22.NamespacesSelectOptions.property.expressions"></a>
...
##### `labels`<sup>Optional</sup> <a name="org.cdk8s.plus22.NamespacesSelectOptions.property.labels"></a>
...
##### `names`<sup>Optional</sup> <a name="org.cdk8s.plus22.NamespacesSelectOptions.property.names"></a>
...
### NetworkPolicyAddEgressRuleOptions <a name="org.cdk8s.plus22.NetworkPolicyAddEgressRuleOptions"></a>
...
```java
import org.cdk8s.plus22.NetworkPolicyAddEgressRuleOptions;
...
##### `ports`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyAddEgressRuleOptions.property.ports"></a>
...
### NetworkPolicyPeerConfig <a name="org.cdk8s.plus22.NetworkPolicyPeerConfig"></a>
...
##### `ipBlock`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyPeerConfig.property.ipBlock"></a>

```java
public NetworkPolicyIpBlock getIpBlock();
```

- *Type:* [`org.cdk8s.plus22.NetworkPolicyIpBlock`](#org.cdk8s.plus22.NetworkPolicyIpBlock)

The ip block this peer represents.

---

##### `podSelector`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyPeerConfig.property.podSelector"></a>

```java
public PodSelectorConfig getPodSelector();
```

- *Type:* [`org.cdk8s.plus22.PodSelectorConfig`](#org.cdk8s.plus22.PodSelectorConfig)

The pod selector this peer represents.

---

### NetworkPolicyPortProps <a name="org.cdk8s.plus22.NetworkPolicyPortProps"></a>
...
```java
import org.cdk8s.plus22.NetworkPolicyPortProps;
...
##### `endPort`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyPortProps.property.endPort"></a>
...
##### `port`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyPortProps.property.port"></a>
...
##### `protocol`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyPortProps.property.protocol"></a>

```java
public NetworkProtocol getProtocol();
```

- *Type:* [`org.cdk8s.plus22.NetworkProtocol`](#org.cdk8s.plus22.NetworkProtocol)
...
### NetworkPolicyProps <a name="org.cdk8s.plus22.NetworkPolicyProps"></a>
...
```java
import org.cdk8s.plus22.NetworkPolicyProps;
...
##### `metadata`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyProps.property.metadata"></a>
...
##### `egress`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyProps.property.egress"></a>
...
##### `ingress`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyProps.property.ingress"></a>
...
##### `selector`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyProps.property.selector"></a>
...
### NetworkPolicyRule <a name="org.cdk8s.plus22.NetworkPolicyRule"></a>
...
```java
import org.cdk8s.plus22.NetworkPolicyRule;
...
##### `peer`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicyRule.property.peer"></a>
...
##### `ports`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyRule.property.ports"></a>
...
### NetworkPolicyTraffic <a name="org.cdk8s.plus22.NetworkPolicyTraffic"></a>
...
```java
import org.cdk8s.plus22.NetworkPolicyTraffic;
...
##### `default`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyTraffic.property.default"></a>

```java
public NetworkPolicyTrafficDefault getDefault();
```

- *Type:* [`org.cdk8s.plus22.NetworkPolicyTrafficDefault`](#org.cdk8s.plus22.NetworkPolicyTrafficDefault)
...
##### `rules`<sup>Optional</sup> <a name="org.cdk8s.plus22.NetworkPolicyTraffic.property.rules"></a>

```java
public java.util.List<NetworkPolicyRule> getRules();
```

- *Type:* java.util.List<[`org.cdk8s.plus22.NetworkPolicyRule`](#org.cdk8s.plus22.NetworkPolicyRule)>
- *Default:* no rules
...
### NodeTaintQueryOptions <a name="org.cdk8s.plus22.NodeTaintQueryOptions"></a>
...
```java
import org.cdk8s.plus22.NodeTaintQueryOptions;
...
##### `effect`<sup>Optional</sup> <a name="org.cdk8s.plus22.NodeTaintQueryOptions.property.effect"></a>

```java
public TaintEffect getEffect();
```

- *Type:* [`org.cdk8s.plus22.TaintEffect`](#org.cdk8s.plus22.TaintEffect)
...
##### `evictAfter`<sup>Optional</sup> <a name="org.cdk8s.plus22.NodeTaintQueryOptions.property.evictAfter"></a>
...
### PodConnectionsAllowFromOptions <a name="org.cdk8s.plus22.PodConnectionsAllowFromOptions"></a>
...
```java
import org.cdk8s.plus22.PodConnectionsAllowFromOptions;
...
##### `isolation`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodConnectionsAllowFromOptions.property.isolation"></a>

```java
public PodConnectionsIsolation getIsolation();
```

- *Type:* [`org.cdk8s.plus22.PodConnectionsIsolation`](#org.cdk8s.plus22.PodConnectionsIsolation)
...
##### `ports`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodConnectionsAllowFromOptions.property.ports"></a>
...
### PodConnectionsAllowToOptions <a name="org.cdk8s.plus22.PodConnectionsAllowToOptions"></a>
...
```java
import org.cdk8s.plus22.PodConnectionsAllowToOptions;
...
##### `isolation`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodConnectionsAllowToOptions.property.isolation"></a>
...
##### `ports`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodConnectionsAllowToOptions.property.ports"></a>
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodProps.property.automountServiceAccountToken"></a>
...
### PodsAllOptions <a name="org.cdk8s.plus22.PodsAllOptions"></a>
...
```java
import org.cdk8s.plus22.PodsAllOptions;
...
##### `namespaces`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodsAllOptions.property.namespaces"></a>

```java
public Namespaces getNamespaces();
```

- *Type:* [`org.cdk8s.plus22.Namespaces`](#org.cdk8s.plus22.Namespaces)
...
### PodSchedulingAttractOptions <a name="org.cdk8s.plus22.PodSchedulingAttractOptions"></a>
...
```java
import org.cdk8s.plus22.PodSchedulingAttractOptions;
...
##### `weight`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodSchedulingAttractOptions.property.weight"></a>
...
### PodSchedulingColocateOptions <a name="org.cdk8s.plus22.PodSchedulingColocateOptions"></a>
...
```java
import org.cdk8s.plus22.PodSchedulingColocateOptions;
...
##### `topology`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodSchedulingColocateOptions.property.topology"></a>

```java
public Topology getTopology();
```

- *Type:* [`org.cdk8s.plus22.Topology`](#org.cdk8s.plus22.Topology)
...
##### `weight`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodSchedulingColocateOptions.property.weight"></a>
...
### PodSchedulingSeparateOptions <a name="org.cdk8s.plus22.PodSchedulingSeparateOptions"></a>
...
```java
import org.cdk8s.plus22.PodSchedulingSeparateOptions;
...
##### `topology`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodSchedulingSeparateOptions.property.topology"></a>
...
##### `weight`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodSchedulingSeparateOptions.property.weight"></a>
...
### PodSelectorConfig <a name="org.cdk8s.plus22.PodSelectorConfig"></a>
...
```java
import org.cdk8s.plus22.PodSelectorConfig;
...
##### `labelSelector`<sup>Required</sup> <a name="org.cdk8s.plus22.PodSelectorConfig.property.labelSelector"></a>
...
##### `namespaces`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodSelectorConfig.property.namespaces"></a>

```java
public NamespaceSelectorConfig getNamespaces();
```

- *Type:* [`org.cdk8s.plus22.NamespaceSelectorConfig`](#org.cdk8s.plus22.NamespaceSelectorConfig)

Configuration for selecting which namepsaces are the pods allowed to be in.

---

### PodsSelectOptions <a name="org.cdk8s.plus22.PodsSelectOptions"></a>
...
```java
import org.cdk8s.plus22.PodsSelectOptions;
...
##### `expressions`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodsSelectOptions.property.expressions"></a>
...
##### `labels`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodsSelectOptions.property.labels"></a>
...
##### `namespaces`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodsSelectOptions.property.namespaces"></a>
...
### RolePolicyRule <a name="org.cdk8s.plus22.RolePolicyRule"></a>
...
```java
import org.cdk8s.plus22.RolePolicyRule;
...
##### `resources`<sup>Required</sup> <a name="org.cdk8s.plus22.RolePolicyRule.property.resources"></a>

```java
public java.util.List<IApiResource> getResources();
```

- *Type:* java.util.List<[`org.cdk8s.plus22.IApiResource`](#org.cdk8s.plus22.IApiResource)>

Resources this rule applies to.

---

##### `verbs`<sup>Required</sup> <a name="org.cdk8s.plus22.RolePolicyRule.property.verbs"></a>
...
##### `automountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.ServiceAccountProps.property.automountToken"></a>
...
### ServiceBindOptions <a name="org.cdk8s.plus22.ServiceBindOptions"></a>
...
```java
import org.cdk8s.plus22.ServiceBindOptions;
...
##### `name`<sup>Optional</sup> <a name="org.cdk8s.plus22.ServiceBindOptions.property.name"></a>
...
##### `nodePort`<sup>Optional</sup> <a name="org.cdk8s.plus22.ServiceBindOptions.property.nodePort"></a>
...
##### `protocol`<sup>Optional</sup> <a name="org.cdk8s.plus22.ServiceBindOptions.property.protocol"></a>
...
##### `targetPort`<sup>Optional</sup> <a name="org.cdk8s.plus22.ServiceBindOptions.property.targetPort"></a>
...
##### `selector`<sup>Optional</sup> <a name="org.cdk8s.plus22.ServiceProps.property.selector"></a>
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.StatefulSetProps.property.automountServiceAccountToken"></a>
...
##### `select`<sup>Optional</sup> <a name="org.cdk8s.plus22.StatefulSetProps.property.select"></a>
...
##### `spread`<sup>Optional</sup> <a name="org.cdk8s.plus22.StatefulSetProps.property.spread"></a>
...
##### `minReady`<sup>Optional</sup> <a name="org.cdk8s.plus22.StatefulSetProps.property.minReady"></a>
...
### SubjectConfiguration <a name="org.cdk8s.plus22.SubjectConfiguration"></a>
...
```java
import org.cdk8s.plus22.SubjectConfiguration;
...
##### `kind`<sup>Required</sup> <a name="org.cdk8s.plus22.SubjectConfiguration.property.kind"></a>
...
##### `name`<sup>Required</sup> <a name="org.cdk8s.plus22.SubjectConfiguration.property.name"></a>
...
##### `apiGroup`<sup>Optional</sup> <a name="org.cdk8s.plus22.SubjectConfiguration.property.apiGroup"></a>
...
##### `namespace`<sup>Optional</sup> <a name="org.cdk8s.plus22.SubjectConfiguration.property.namespace"></a>
...
##### `automountServiceAccountToken`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadProps.property.automountServiceAccountToken"></a>
...
##### `dns`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadProps.property.dns"></a>
...
##### `dockerRegistryAuth`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadProps.property.dockerRegistryAuth"></a>
...
##### `select`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadProps.property.select"></a>
...
##### `spread`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadProps.property.spread"></a>
...
### WorkloadSchedulingSpreadOptions <a name="org.cdk8s.plus22.WorkloadSchedulingSpreadOptions"></a>
...
```java
import org.cdk8s.plus22.WorkloadSchedulingSpreadOptions;
...
##### `topology`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadSchedulingSpreadOptions.property.topology"></a>
...
##### `weight`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadSchedulingSpreadOptions.property.weight"></a>
...
- *Implements:* [`org.cdk8s.plus22.IApiResource`](#org.cdk8s.plus22.IApiResource), [`org.cdk8s.plus22.IApiEndpoint`](#org.cdk8s.plus22.IApiEndpoint)

Represents information about an API resource type.

#### Methods <a name="Methods"></a>

##### `asApiResource` <a name="org.cdk8s.plus22.ApiResource.asApiResource"></a>

```java
public asApiResource()
```

##### `asNonApiResource` <a name="org.cdk8s.plus22.ApiResource.asNonApiResource"></a>
...
##### `envFrom`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerProps.parameter.envFrom"></a>
...
##### `envVariables`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerProps.parameter.envVariables"></a>
...
##### `portNumber`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerProps.parameter.portNumber"></a>
...
##### `ports`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerProps.parameter.ports"></a>
...
##### `addPort` <a name="org.cdk8s.plus22.Container.addPort"></a>

```java
public addPort(ContainerPort port)
```

###### `port`<sup>Required</sup> <a name="org.cdk8s.plus22.Container.parameter.port"></a>

- *Type:* [`org.cdk8s.plus22.ContainerPort`](#org.cdk8s.plus22.ContainerPort)
...
- *Type:* [`org.cdk8s.plus22.Env`](#org.cdk8s.plus22.Env)
...
##### `ports`<sup>Required</sup> <a name="org.cdk8s.plus22.Container.property.ports"></a>
...
##### `portNumber`<sup>Optional</sup> <a name="org.cdk8s.plus22.Container.property.portNumber"></a>
...
##### `allowPrivilegeEscalation`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerSecurityContextProps.parameter.allowPrivilegeEscalation"></a>
...
##### `allowPrivilegeEscalation`<sup>Optional</sup> <a name="org.cdk8s.plus22.ContainerSecurityContext.property.allowPrivilegeEscalation"></a>
...
### Env <a name="org.cdk8s.plus22.Env"></a>

Container environment variables.

#### Initializers <a name="org.cdk8s.plus22.Env.Initializer"></a>

```java
import org.cdk8s.plus22.Env;

new Env(java.util.List<EnvFrom> sources, java.util.Map<java.lang.String, EnvValue> variables);
```

##### `sources`<sup>Required</sup> <a name="org.cdk8s.plus22.Env.parameter.sources"></a>

- *Type:* java.util.List<[`org.cdk8s.plus22.EnvFrom`](#org.cdk8s.plus22.EnvFrom)>

---

##### `variables`<sup>Required</sup> <a name="org.cdk8s.plus22.Env.parameter.variables"></a>
...
##### `addVariable` <a name="org.cdk8s.plus22.Env.addVariable"></a>

```java
public addVariable(java.lang.String name, EnvValue value)
```

###### `name`<sup>Required</sup> <a name="org.cdk8s.plus22.Env.parameter.name"></a>

- *Type:* `java.lang.String`

---

###### `value`<sup>Required</sup> <a name="org.cdk8s.plus22.Env.parameter.value"></a>

- *Type:* [`org.cdk8s.plus22.EnvValue`](#org.cdk8s.plus22.EnvValue)

---

##### `copyFrom` <a name="org.cdk8s.plus22.Env.copyFrom"></a>

```java
public copyFrom(EnvFrom from)
```

###### `from`<sup>Required</sup> <a name="org.cdk8s.plus22.Env.parameter.from"></a>

- *Type:* [`org.cdk8s.plus22.EnvFrom`](#org.cdk8s.plus22.EnvFrom)

---

#### Static Functions <a name="Static Functions"></a>

##### `fromConfigMap` <a name="org.cdk8s.plus22.Env.fromConfigMap"></a>
...
###### `configMap`<sup>Required</sup> <a name="org.cdk8s.plus22.Env.parameter.configMap"></a>

- *Type:* [`org.cdk8s.plus22.IConfigMap`](#org.cdk8s.plus22.IConfigMap)

---

###### `prefix`<sup>Optional</sup> <a name="org.cdk8s.plus22.Env.parameter.prefix"></a>

- *Type:* `java.lang.String`

---

##### `fromSecret` <a name="org.cdk8s.plus22.Env.fromSecret"></a>
...
###### `secr`<sup>Required</sup> <a name="org.cdk8s.plus22.Env.parameter.secr"></a>
...
##### `sources`<sup>Required</sup> <a name="org.cdk8s.plus22.Env.property.sources"></a>
...
##### `variables`<sup>Required</sup> <a name="org.cdk8s.plus22.Env.property.variables"></a>
...
### EnvFrom <a name="org.cdk8s.plus22.EnvFrom"></a>

A collection of env variables defined in other resources.

#### Initializers <a name="org.cdk8s.plus22.EnvFrom.Initializer"></a>

```java
import org.cdk8s.plus22.EnvFrom;
...
##### `configMap`<sup>Optional</sup> <a name="org.cdk8s.plus22.EnvFrom.parameter.configMap"></a>

- *Type:* [`org.cdk8s.plus22.IConfigMap`](#org.cdk8s.plus22.IConfigMap)

---

##### `prefix`<sup>Optional</sup> <a name="org.cdk8s.plus22.EnvFrom.parameter.prefix"></a>

- *Type:* `java.lang.String`

---

##### `sec`<sup>Optional</sup> <a name="org.cdk8s.plus22.EnvFrom.parameter.sec"></a>
...
##### `fromResource` <a name="org.cdk8s.plus22.IngressBackend.fromResource"></a>
...
###### `resource`<sup>Required</sup> <a name="org.cdk8s.plus22.IngressBackend.parameter.resource"></a>
...
### LabeledNode <a name="org.cdk8s.plus22.LabeledNode"></a>

A node that is matched by label selectors.

#### Initializers <a name="org.cdk8s.plus22.LabeledNode.Initializer"></a>
...
##### `labelSelector`<sup>Required</sup> <a name="org.cdk8s.plus22.LabeledNode.parameter.labelSelector"></a>

- *Type:* java.util.List<[`org.cdk8s.plus22.NodeLabelQuery`](#org.cdk8s.plus22.NodeLabelQuery)>
...
##### `labelSelector`<sup>Required</sup> <a name="org.cdk8s.plus22.LabeledNode.property.labelSelector"></a>
...
### LabelExpression <a name="org.cdk8s.plus22.LabelExpression"></a>
...
##### `doesNotExist` <a name="org.cdk8s.plus22.LabelExpression.doesNotExist"></a>

```java
import org.cdk8s.plus22.LabelExpression;

LabelExpression.doesNotExist(java.lang.String key)
```

###### `key`<sup>Required</sup> <a name="org.cdk8s.plus22.LabelExpression.parameter.key"></a>

- *Type:* `java.lang.String`

---

##### `exists` <a name="org.cdk8s.plus22.LabelExpression.exists"></a>
...
##### `in` <a name="org.cdk8s.plus22.LabelExpression.in"></a>
...
###### `values`<sup>Required</sup> <a name="org.cdk8s.plus22.LabelExpression.parameter.values"></a>

- *Type:* java.util.List<`java.lang.String`>

---

##### `notIn` <a name="org.cdk8s.plus22.LabelExpression.notIn"></a>
...
##### `key`<sup>Required</sup> <a name="org.cdk8s.plus22.LabelExpression.property.key"></a>
...
##### `operator`<sup>Required</sup> <a name="org.cdk8s.plus22.LabelExpression.property.operator"></a>
...
##### `values`<sup>Optional</sup> <a name="org.cdk8s.plus22.LabelExpression.property.values"></a>
...
### LabelSelector <a name="org.cdk8s.plus22.LabelSelector"></a>

Match a resource by labels.

#### Methods <a name="Methods"></a>

##### `isEmpty` <a name="org.cdk8s.plus22.LabelSelector.isEmpty"></a>
...
##### `of` <a name="org.cdk8s.plus22.LabelSelector.of"></a>

```java
import org.cdk8s.plus22.LabelSelector;

LabelSelector.of()
LabelSelector.of(LabelSelectorOptions options)
```

###### `options`<sup>Optional</sup> <a name="org.cdk8s.plus22.LabelSelector.parameter.options"></a>

- *Type:* [`org.cdk8s.plus22.LabelSelectorOptions`](#org.cdk8s.plus22.LabelSelectorOptions)

---



### NamedNode <a name="org.cdk8s.plus22.NamedNode"></a>

A node that is matched by its name.

#### Initializers <a name="org.cdk8s.plus22.NamedNode.Initializer"></a>

```java
import org.cdk8s.plus22.NamedNode;

new NamedNode(java.lang.String name);
```

##### `name`<sup>Required</sup> <a name="org.cdk8s.plus22.NamedNode.parameter.name"></a>
...
##### `name`<sup>Required</sup> <a name="org.cdk8s.plus22.NamedNode.property.name"></a>
...
### NetworkPolicyPort <a name="org.cdk8s.plus22.NetworkPolicyPort"></a>
...
##### `allTcp` <a name="org.cdk8s.plus22.NetworkPolicyPort.allTcp"></a>

```java
import org.cdk8s.plus22.NetworkPolicyPort;

NetworkPolicyPort.allTcp()
```

##### `allUdp` <a name="org.cdk8s.plus22.NetworkPolicyPort.allUdp"></a>
...
##### `of` <a name="org.cdk8s.plus22.NetworkPolicyPort.of"></a>
...
###### `props`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicyPort.parameter.props"></a>

- *Type:* [`org.cdk8s.plus22.NetworkPolicyPortProps`](#org.cdk8s.plus22.NetworkPolicyPortProps)

---

##### `tcp` <a name="org.cdk8s.plus22.NetworkPolicyPort.tcp"></a>
...
###### `port`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicyPort.parameter.port"></a>

- *Type:* `java.lang.Number`

---

##### `tcpRange` <a name="org.cdk8s.plus22.NetworkPolicyPort.tcpRange"></a>
...
###### `startPort`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicyPort.parameter.startPort"></a>

- *Type:* `java.lang.Number`

---

###### `endPort`<sup>Required</sup> <a name="org.cdk8s.plus22.NetworkPolicyPort.parameter.endPort"></a>

- *Type:* `java.lang.Number`

---

##### `udp` <a name="org.cdk8s.plus22.NetworkPolicyPort.udp"></a>
...
##### `udpRange` <a name="org.cdk8s.plus22.NetworkPolicyPort.udpRange"></a>
...
### Node <a name="org.cdk8s.plus22.Node"></a>

Represents a node in the cluster.

#### Initializers <a name="org.cdk8s.plus22.Node.Initializer"></a>

```java
import org.cdk8s.plus22.Node;
...
##### `labeled` <a name="org.cdk8s.plus22.Node.labeled"></a>
...
###### `labelSelector`<sup>Required</sup> <a name="org.cdk8s.plus22.Node.parameter.labelSelector"></a>

- *Type:* [`org.cdk8s.plus22.NodeLabelQuery`](#org.cdk8s.plus22.NodeLabelQuery)

---

##### `named` <a name="org.cdk8s.plus22.Node.named"></a>
...
###### `nodeName`<sup>Required</sup> <a name="org.cdk8s.plus22.Node.parameter.nodeName"></a>

- *Type:* `java.lang.String`

---

##### `tainted` <a name="org.cdk8s.plus22.Node.tainted"></a>
...
###### `taintSelector`<sup>Required</sup> <a name="org.cdk8s.plus22.Node.parameter.taintSelector"></a>

- *Type:* [`org.cdk8s.plus22.NodeTaintQuery`](#org.cdk8s.plus22.NodeTaintQuery)

---



### NodeLabelQuery <a name="org.cdk8s.plus22.NodeLabelQuery"></a>
...
##### `doesNotExist` <a name="org.cdk8s.plus22.NodeLabelQuery.doesNotExist"></a>

```java
import org.cdk8s.plus22.NodeLabelQuery;

NodeLabelQuery.doesNotExist(java.lang.String key)
```

###### `key`<sup>Required</sup> <a name="org.cdk8s.plus22.NodeLabelQuery.parameter.key"></a>

- *Type:* `java.lang.String`

---

##### `exists` <a name="org.cdk8s.plus22.NodeLabelQuery.exists"></a>
...
##### `gt` <a name="org.cdk8s.plus22.NodeLabelQuery.gt"></a>
...
###### `values`<sup>Required</sup> <a name="org.cdk8s.plus22.NodeLabelQuery.parameter.values"></a>

- *Type:* java.util.List<`java.lang.String`>

---

##### `in` <a name="org.cdk8s.plus22.NodeLabelQuery.in"></a>
...
##### `is` <a name="org.cdk8s.plus22.NodeLabelQuery.is"></a>
...
###### `value`<sup>Required</sup> <a name="org.cdk8s.plus22.NodeLabelQuery.parameter.value"></a>

- *Type:* `java.lang.String`

---

##### `lt` <a name="org.cdk8s.plus22.NodeLabelQuery.lt"></a>
...
##### `notIn` <a name="org.cdk8s.plus22.NodeLabelQuery.notIn"></a>
...
##### `key`<sup>Required</sup> <a name="org.cdk8s.plus22.NodeLabelQuery.property.key"></a>
...
##### `operator`<sup>Required</sup> <a name="org.cdk8s.plus22.NodeLabelQuery.property.operator"></a>
...
##### `values`<sup>Optional</sup> <a name="org.cdk8s.plus22.NodeLabelQuery.property.values"></a>
...
### NodeTaintQuery <a name="org.cdk8s.plus22.NodeTaintQuery"></a>
...
##### `any` <a name="org.cdk8s.plus22.NodeTaintQuery.any"></a>

```java
import org.cdk8s.plus22.NodeTaintQuery;

NodeTaintQuery.any()
```

##### `exists` <a name="org.cdk8s.plus22.NodeTaintQuery.exists"></a>
...
###### `key`<sup>Required</sup> <a name="org.cdk8s.plus22.NodeTaintQuery.parameter.key"></a>

- *Type:* `java.lang.String`

---

###### `options`<sup>Optional</sup> <a name="org.cdk8s.plus22.NodeTaintQuery.parameter.options"></a>

- *Type:* [`org.cdk8s.plus22.NodeTaintQueryOptions`](#org.cdk8s.plus22.NodeTaintQueryOptions)

---

##### `is` <a name="org.cdk8s.plus22.NodeTaintQuery.is"></a>
...
###### `value`<sup>Required</sup> <a name="org.cdk8s.plus22.NodeTaintQuery.parameter.value"></a>
...
##### `operator`<sup>Required</sup> <a name="org.cdk8s.plus22.NodeTaintQuery.property.operator"></a>
...
##### `effect`<sup>Optional</sup> <a name="org.cdk8s.plus22.NodeTaintQuery.property.effect"></a>
...
##### `evictAfter`<sup>Optional</sup> <a name="org.cdk8s.plus22.NodeTaintQuery.property.evictAfter"></a>
...
##### `key`<sup>Optional</sup> <a name="org.cdk8s.plus22.NodeTaintQuery.property.key"></a>
...
##### `value`<sup>Optional</sup> <a name="org.cdk8s.plus22.NodeTaintQuery.property.value"></a>
...
### NonApiResource <a name="org.cdk8s.plus22.NonApiResource"></a>

- *Implements:* [`org.cdk8s.plus22.IApiEndpoint`](#org.cdk8s.plus22.IApiEndpoint)

Factory for creating non api resources.

#### Methods <a name="Methods"></a>

##### `asApiResource` <a name="org.cdk8s.plus22.NonApiResource.asApiResource"></a>

```java
public asApiResource()
```

##### `asNonApiResource` <a name="org.cdk8s.plus22.NonApiResource.asNonApiResource"></a>
...
##### `of` <a name="org.cdk8s.plus22.NonApiResource.of"></a>

```java
import org.cdk8s.plus22.NonApiResource;

NonApiResource.of(java.lang.String url)
```

###### `url`<sup>Required</sup> <a name="org.cdk8s.plus22.NonApiResource.parameter.url"></a>
...
### PodConnections <a name="org.cdk8s.plus22.PodConnections"></a>

Controls network isolation rules for inter-pod communication.

#### Initializers <a name="org.cdk8s.plus22.PodConnections.Initializer"></a>

```java
import org.cdk8s.plus22.PodConnections;

new PodConnections(AbstractPod instance);
```

##### `instance`<sup>Required</sup> <a name="org.cdk8s.plus22.PodConnections.parameter.instance"></a>

- *Type:* [`org.cdk8s.plus22.AbstractPod`](#org.cdk8s.plus22.AbstractPod)

---

#### Methods <a name="Methods"></a>

##### `allowFrom` <a name="org.cdk8s.plus22.PodConnections.allowFrom"></a>
...
###### `peer`<sup>Required</sup> <a name="org.cdk8s.plus22.PodConnections.parameter.peer"></a>

- *Type:* [`org.cdk8s.plus22.INetworkPolicyPeer`](#org.cdk8s.plus22.INetworkPolicyPeer)

---

###### `options`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodConnections.parameter.options"></a>

- *Type:* [`org.cdk8s.plus22.PodConnectionsAllowFromOptions`](#org.cdk8s.plus22.PodConnectionsAllowFromOptions)

---

##### `allowTo` <a name="org.cdk8s.plus22.PodConnections.allowTo"></a>
...
- *Type:* [`org.cdk8s.plus22.PodConnectionsAllowToOptions`](#org.cdk8s.plus22.PodConnectionsAllowToOptions)
...
### PodScheduling <a name="org.cdk8s.plus22.PodScheduling"></a>

Controls the pod scheduling strategy.

#### Initializers <a name="org.cdk8s.plus22.PodScheduling.Initializer"></a>

```java
import org.cdk8s.plus22.PodScheduling;

new PodScheduling(AbstractPod instance);
```

##### `instance`<sup>Required</sup> <a name="org.cdk8s.plus22.PodScheduling.parameter.instance"></a>
...
##### `assign` <a name="org.cdk8s.plus22.PodScheduling.assign"></a>

```java
public assign(NamedNode node)
```

###### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.PodScheduling.parameter.node"></a>

- *Type:* [`org.cdk8s.plus22.NamedNode`](#org.cdk8s.plus22.NamedNode)

---

##### `attract` <a name="org.cdk8s.plus22.PodScheduling.attract"></a>
...
- *Type:* [`org.cdk8s.plus22.LabeledNode`](#org.cdk8s.plus22.LabeledNode)

---

###### `options`<sup>Optional</sup> <a name="org.cdk8s.plus22.PodScheduling.parameter.options"></a>

- *Type:* [`org.cdk8s.plus22.PodSchedulingAttractOptions`](#org.cdk8s.plus22.PodSchedulingAttractOptions)

---

##### `colocate` <a name="org.cdk8s.plus22.PodScheduling.colocate"></a>
...
###### `selector`<sup>Required</sup> <a name="org.cdk8s.plus22.PodScheduling.parameter.selector"></a>
...
- *Type:* [`org.cdk8s.plus22.PodSchedulingColocateOptions`](#org.cdk8s.plus22.PodSchedulingColocateOptions)

---

##### `separate` <a name="org.cdk8s.plus22.PodScheduling.separate"></a>
...
- *Type:* [`org.cdk8s.plus22.PodSchedulingSeparateOptions`](#org.cdk8s.plus22.PodSchedulingSeparateOptions)

---

##### `tolerate` <a name="org.cdk8s.plus22.PodScheduling.tolerate"></a>
...
- *Type:* [`org.cdk8s.plus22.TaintedNode`](#org.cdk8s.plus22.TaintedNode)
...
### ResourcePermissions <a name="org.cdk8s.plus22.ResourcePermissions"></a>

Controls permissions for operations on resources.

#### Initializers <a name="org.cdk8s.plus22.ResourcePermissions.Initializer"></a>

```java
import org.cdk8s.plus22.ResourcePermissions;

new ResourcePermissions(Resource instance);
```

##### `instance`<sup>Required</sup> <a name="org.cdk8s.plus22.ResourcePermissions.parameter.instance"></a>

- *Type:* [`org.cdk8s.plus22.Resource`](#org.cdk8s.plus22.Resource)

---

#### Methods <a name="Methods"></a>

##### `grantRead` <a name="org.cdk8s.plus22.ResourcePermissions.grantRead"></a>

```java
public grantRead(ISubject subjects)
```

###### `subjects`<sup>Required</sup> <a name="org.cdk8s.plus22.ResourcePermissions.parameter.subjects"></a>

- *Type:* [`org.cdk8s.plus22.ISubject`](#org.cdk8s.plus22.ISubject)

---

##### `grantReadWrite` <a name="org.cdk8s.plus22.ResourcePermissions.grantReadWrite"></a>
...
### TaintedNode <a name="org.cdk8s.plus22.TaintedNode"></a>

A node that is matched by taint selectors.

#### Initializers <a name="org.cdk8s.plus22.TaintedNode.Initializer"></a>

```java
import org.cdk8s.plus22.TaintedNode;

new TaintedNode(java.util.List<NodeTaintQuery> taintSelector);
```

##### `taintSelector`<sup>Required</sup> <a name="org.cdk8s.plus22.TaintedNode.parameter.taintSelector"></a>

- *Type:* java.util.List<[`org.cdk8s.plus22.NodeTaintQuery`](#org.cdk8s.plus22.NodeTaintQuery)>
...
##### `taintSelector`<sup>Required</sup> <a name="org.cdk8s.plus22.TaintedNode.property.taintSelector"></a>
...
### Topology <a name="org.cdk8s.plus22.Topology"></a>
...
##### `custom` <a name="org.cdk8s.plus22.Topology.custom"></a>

```java
import org.cdk8s.plus22.Topology;

Topology.custom(java.lang.String key)
```

###### `key`<sup>Required</sup> <a name="org.cdk8s.plus22.Topology.parameter.key"></a>
...
##### `key`<sup>Required</sup> <a name="org.cdk8s.plus22.Topology.property.key"></a>
...
##### `HOSTNAME` <a name="org.cdk8s.plus22.Topology.property.HOSTNAME"></a>
...
##### `REGION` <a name="org.cdk8s.plus22.Topology.property.REGION"></a>
...
##### `ZONE` <a name="org.cdk8s.plus22.Topology.property.ZONE"></a>
...
### WorkloadScheduling <a name="org.cdk8s.plus22.WorkloadScheduling"></a>

Controls the pod scheduling strategy of this workload.

It offers some additional API's on top of the core pod scheduling.

#### Initializers <a name="org.cdk8s.plus22.WorkloadScheduling.Initializer"></a>

```java
import org.cdk8s.plus22.WorkloadScheduling;

new WorkloadScheduling(AbstractPod instance);
```

##### `instance`<sup>Required</sup> <a name="org.cdk8s.plus22.WorkloadScheduling.parameter.instance"></a>
...
##### `spread` <a name="org.cdk8s.plus22.WorkloadScheduling.spread"></a>
...
###### `options`<sup>Optional</sup> <a name="org.cdk8s.plus22.WorkloadScheduling.parameter.options"></a>

- *Type:* [`org.cdk8s.plus22.WorkloadSchedulingSpreadOptions`](#org.cdk8s.plus22.WorkloadSchedulingSpreadOptions)
...
##### `asApiResource` <a name="org.cdk8s.plus22.IApiEndpoint.asApiResource"></a>

```java
public asApiResource()
```

##### `asNonApiResource` <a name="org.cdk8s.plus22.IApiEndpoint.asNonApiResource"></a>
...
- *Implemented By:* [`org.cdk8s.plus22.AbstractPod`](#org.cdk8s.plus22.AbstractPod), [`org.cdk8s.plus22.ApiResource`](#org.cdk8s.plus22.ApiResource), [`org.cdk8s.plus22.AwsElasticBlockStorePersistentVolume`](#org.cdk8s.plus22.AwsElasticBlockStorePersistentVolume), [`org.cdk8s.plus22.AzureDiskPersistentVolume`](#org.cdk8s.plus22.AzureDiskPersistentVolume), [`org.cdk8s.plus22.BasicAuthSecret`](#org.cdk8s.plus22.BasicAuthSecret), [`org.cdk8s.plus22.ClusterRole`](#org.cdk8s.plus22.ClusterRole), [`org.cdk8s.plus22.ClusterRoleBinding`](#org.cdk8s.plus22.ClusterRoleBinding), [`org.cdk8s.plus22.ConfigMap`](#org.cdk8s.plus22.ConfigMap), [`org.cdk8s.plus22.CronJob`](#org.cdk8s.plus22.CronJob), [`org.cdk8s.plus22.DaemonSet`](#org.cdk8s.plus22.DaemonSet), [`org.cdk8s.plus22.Deployment`](#org.cdk8s.plus22.Deployment), [`org.cdk8s.plus22.DockerConfigSecret`](#org.cdk8s.plus22.DockerConfigSecret), [`org.cdk8s.plus22.GCEPersistentDiskPersistentVolume`](#org.cdk8s.plus22.GCEPersistentDiskPersistentVolume), [`org.cdk8s.plus22.Ingress`](#org.cdk8s.plus22.Ingress), [`org.cdk8s.plus22.Job`](#org.cdk8s.plus22.Job), [`org.cdk8s.plus22.Namespace`](#org.cdk8s.plus22.Namespace), [`org.cdk8s.plus22.NetworkPolicy`](#org.cdk8s.plus22.NetworkPolicy), [`org.cdk8s.plus22.PersistentVolume`](#org.cdk8s.plus22.PersistentVolume), [`org.cdk8s.plus22.PersistentVolumeClaim`](#org.cdk8s.plus22.PersistentVolumeClaim), [`org.cdk8s.plus22.Pod`](#org.cdk8s.plus22.Pod), [`org.cdk8s.plus22.Resource`](#org.cdk8s.plus22.Resource), [`org.cdk8s.plus22.Role`](#org.cdk8s.plus22.Role), [`org.cdk8s.plus22.RoleBinding`](#org.cdk8s.plus22.RoleBinding), [`org.cdk8s.plus22.Secret`](#org.cdk8s.plus22.Secret), [`org.cdk8s.plus22.Service`](#org.cdk8s.plus22.Service), [`org.cdk8s.plus22.ServiceAccount`](#org.cdk8s.plus22.ServiceAccount), [`org.cdk8s.plus22.ServiceAccountTokenSecret`](#org.cdk8s.plus22.ServiceAccountTokenSecret), [`org.cdk8s.plus22.SshAuthSecret`](#org.cdk8s.plus22.SshAuthSecret), [`org.cdk8s.plus22.StatefulSet`](#org.cdk8s.plus22.StatefulSet), [`org.cdk8s.plus22.TlsSecret`](#org.cdk8s.plus22.TlsSecret), [`org.cdk8s.plus22.Workload`](#org.cdk8s.plus22.Workload), [`org.cdk8s.plus22.IApiResource`](#org.cdk8s.plus22.IApiResource)
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.IClusterRole.property.node"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.IConfigMap.property.node"></a>
...
### INamespaceSelector <a name="org.cdk8s.plus22.INamespaceSelector"></a>

- *Extends:* [`software.constructs.IConstruct`](#software.constructs.IConstruct)

- *Implemented By:* [`org.cdk8s.plus22.Namespace`](#org.cdk8s.plus22.Namespace), [`org.cdk8s.plus22.Namespaces`](#org.cdk8s.plus22.Namespaces), [`org.cdk8s.plus22.INamespaceSelector`](#org.cdk8s.plus22.INamespaceSelector)

Represents an object that can select namespaces.

#### Methods <a name="Methods"></a>

##### `toNamespaceSelectorConfig` <a name="org.cdk8s.plus22.INamespaceSelector.toNamespaceSelectorConfig"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.INamespaceSelector.property.node"></a>
...
### INetworkPolicyPeer <a name="org.cdk8s.plus22.INetworkPolicyPeer"></a>

- *Extends:* [`software.constructs.IConstruct`](#software.constructs.IConstruct)

- *Implemented By:* [`org.cdk8s.plus22.AbstractPod`](#org.cdk8s.plus22.AbstractPod), [`org.cdk8s.plus22.CronJob`](#org.cdk8s.plus22.CronJob), [`org.cdk8s.plus22.DaemonSet`](#org.cdk8s.plus22.DaemonSet), [`org.cdk8s.plus22.Deployment`](#org.cdk8s.plus22.Deployment), [`org.cdk8s.plus22.Job`](#org.cdk8s.plus22.Job), [`org.cdk8s.plus22.Namespace`](#org.cdk8s.plus22.Namespace), [`org.cdk8s.plus22.Namespaces`](#org.cdk8s.plus22.Namespaces), [`org.cdk8s.plus22.NetworkPolicyIpBlock`](#org.cdk8s.plus22.NetworkPolicyIpBlock), [`org.cdk8s.plus22.Pod`](#org.cdk8s.plus22.Pod), [`org.cdk8s.plus22.StatefulSet`](#org.cdk8s.plus22.StatefulSet), [`org.cdk8s.plus22.Workload`](#org.cdk8s.plus22.Workload), [`org.cdk8s.plus22.INetworkPolicyPeer`](#org.cdk8s.plus22.INetworkPolicyPeer)

Describes a peer to allow traffic to/from.

#### Methods <a name="Methods"></a>

##### `toNetworkPolicyPeerConfig` <a name="org.cdk8s.plus22.INetworkPolicyPeer.toNetworkPolicyPeerConfig"></a>

```java
public toNetworkPolicyPeerConfig()
```

##### `toPodSelector` <a name="org.cdk8s.plus22.INetworkPolicyPeer.toPodSelector"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.INetworkPolicyPeer.property.node"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.IPersistentVolume.property.node"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.IPersistentVolumeClaim.property.node"></a>
...
### IPodSelector <a name="org.cdk8s.plus22.IPodSelector"></a>

- *Extends:* [`software.constructs.IConstruct`](#software.constructs.IConstruct)

- *Implemented By:* [`org.cdk8s.plus22.AbstractPod`](#org.cdk8s.plus22.AbstractPod), [`org.cdk8s.plus22.CronJob`](#org.cdk8s.plus22.CronJob), [`org.cdk8s.plus22.DaemonSet`](#org.cdk8s.plus22.DaemonSet), [`org.cdk8s.plus22.Deployment`](#org.cdk8s.plus22.Deployment), [`org.cdk8s.plus22.Job`](#org.cdk8s.plus22.Job), [`org.cdk8s.plus22.Pod`](#org.cdk8s.plus22.Pod), [`org.cdk8s.plus22.Pods`](#org.cdk8s.plus22.Pods), [`org.cdk8s.plus22.StatefulSet`](#org.cdk8s.plus22.StatefulSet), [`org.cdk8s.plus22.Workload`](#org.cdk8s.plus22.Workload), [`org.cdk8s.plus22.IPodSelector`](#org.cdk8s.plus22.IPodSelector)

Represents an object that can select pods.

#### Methods <a name="Methods"></a>

##### `toPodSelectorConfig` <a name="org.cdk8s.plus22.IPodSelector.toPodSelectorConfig"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.IPodSelector.property.node"></a>
...
- *Implemented By:* [`org.cdk8s.plus22.AbstractPod`](#org.cdk8s.plus22.AbstractPod), [`org.cdk8s.plus22.AwsElasticBlockStorePersistentVolume`](#org.cdk8s.plus22.AwsElasticBlockStorePersistentVolume), [`org.cdk8s.plus22.AzureDiskPersistentVolume`](#org.cdk8s.plus22.AzureDiskPersistentVolume), [`org.cdk8s.plus22.BasicAuthSecret`](#org.cdk8s.plus22.BasicAuthSecret), [`org.cdk8s.plus22.ClusterRole`](#org.cdk8s.plus22.ClusterRole), [`org.cdk8s.plus22.ClusterRoleBinding`](#org.cdk8s.plus22.ClusterRoleBinding), [`org.cdk8s.plus22.ConfigMap`](#org.cdk8s.plus22.ConfigMap), [`org.cdk8s.plus22.CronJob`](#org.cdk8s.plus22.CronJob), [`org.cdk8s.plus22.DaemonSet`](#org.cdk8s.plus22.DaemonSet), [`org.cdk8s.plus22.Deployment`](#org.cdk8s.plus22.Deployment), [`org.cdk8s.plus22.DockerConfigSecret`](#org.cdk8s.plus22.DockerConfigSecret), [`org.cdk8s.plus22.GCEPersistentDiskPersistentVolume`](#org.cdk8s.plus22.GCEPersistentDiskPersistentVolume), [`org.cdk8s.plus22.Ingress`](#org.cdk8s.plus22.Ingress), [`org.cdk8s.plus22.Job`](#org.cdk8s.plus22.Job), [`org.cdk8s.plus22.Namespace`](#org.cdk8s.plus22.Namespace), [`org.cdk8s.plus22.NetworkPolicy`](#org.cdk8s.plus22.NetworkPolicy), [`org.cdk8s.plus22.PersistentVolume`](#org.cdk8s.plus22.PersistentVolume), [`org.cdk8s.plus22.PersistentVolumeClaim`](#org.cdk8s.plus22.PersistentVolumeClaim), [`org.cdk8s.plus22.Pod`](#org.cdk8s.plus22.Pod), [`org.cdk8s.plus22.Resource`](#org.cdk8s.plus22.Resource), [`org.cdk8s.plus22.Role`](#org.cdk8s.plus22.Role), [`org.cdk8s.plus22.RoleBinding`](#org.cdk8s.plus22.RoleBinding), [`org.cdk8s.plus22.Secret`](#org.cdk8s.plus22.Secret), [`org.cdk8s.plus22.Service`](#org.cdk8s.plus22.Service), [`org.cdk8s.plus22.ServiceAccount`](#org.cdk8s.plus22.ServiceAccount), [`org.cdk8s.plus22.ServiceAccountTokenSecret`](#org.cdk8s.plus22.ServiceAccountTokenSecret), [`org.cdk8s.plus22.SshAuthSecret`](#org.cdk8s.plus22.SshAuthSecret), [`org.cdk8s.plus22.StatefulSet`](#org.cdk8s.plus22.StatefulSet), [`org.cdk8s.plus22.TlsSecret`](#org.cdk8s.plus22.TlsSecret), [`org.cdk8s.plus22.Workload`](#org.cdk8s.plus22.Workload), [`org.cdk8s.plus22.IClusterRole`](#org.cdk8s.plus22.IClusterRole), [`org.cdk8s.plus22.IConfigMap`](#org.cdk8s.plus22.IConfigMap), [`org.cdk8s.plus22.IPersistentVolume`](#org.cdk8s.plus22.IPersistentVolume), [`org.cdk8s.plus22.IPersistentVolumeClaim`](#org.cdk8s.plus22.IPersistentVolumeClaim), [`org.cdk8s.plus22.IResource`](#org.cdk8s.plus22.IResource), [`org.cdk8s.plus22.IRole`](#org.cdk8s.plus22.IRole), [`org.cdk8s.plus22.ISecret`](#org.cdk8s.plus22.ISecret), [`org.cdk8s.plus22.IServiceAccount`](#org.cdk8s.plus22.IServiceAccount)
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.IResource.property.node"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.IRole.property.node"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.ISecret.property.node"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.IServiceAccount.property.node"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.IStorage.property.node"></a>
...
- *Implemented By:* [`org.cdk8s.plus22.AbstractPod`](#org.cdk8s.plus22.AbstractPod), [`org.cdk8s.plus22.CronJob`](#org.cdk8s.plus22.CronJob), [`org.cdk8s.plus22.DaemonSet`](#org.cdk8s.plus22.DaemonSet), [`org.cdk8s.plus22.Deployment`](#org.cdk8s.plus22.Deployment), [`org.cdk8s.plus22.Group`](#org.cdk8s.plus22.Group), [`org.cdk8s.plus22.Job`](#org.cdk8s.plus22.Job), [`org.cdk8s.plus22.Pod`](#org.cdk8s.plus22.Pod), [`org.cdk8s.plus22.ServiceAccount`](#org.cdk8s.plus22.ServiceAccount), [`org.cdk8s.plus22.StatefulSet`](#org.cdk8s.plus22.StatefulSet), [`org.cdk8s.plus22.User`](#org.cdk8s.plus22.User), [`org.cdk8s.plus22.Workload`](#org.cdk8s.plus22.Workload), [`org.cdk8s.plus22.ISubject`](#org.cdk8s.plus22.ISubject)

Represents an object that can be used as a role binding subject.

#### Methods <a name="Methods"></a>

##### `toSubjectConfiguration` <a name="org.cdk8s.plus22.ISubject.toSubjectConfiguration"></a>
...
##### `node`<sup>Required</sup> <a name="org.cdk8s.plus22.ISubject.property.node"></a>
...
#### `ALLOW` <a name="org.cdk8s.plus22.ConcurrencyPolicy.ALLOW"></a>
...
#### `FORBID` <a name="org.cdk8s.plus22.ConcurrencyPolicy.FORBID"></a>
...
#### `REPLACE` <a name="org.cdk8s.plus22.ConcurrencyPolicy.REPLACE"></a>
...
#### `HTTP` <a name="org.cdk8s.plus22.ConnectionScheme.HTTP"></a>
...
#### `HTTPS` <a name="org.cdk8s.plus22.ConnectionScheme.HTTPS"></a>
...
#### `DEFAULT` <a name="org.cdk8s.plus22.HostPathVolumeType.DEFAULT"></a>
...
#### `DIRECTORY_OR_CREATE` <a name="org.cdk8s.plus22.HostPathVolumeType.DIRECTORY_OR_CREATE"></a>
...
#### `DIRECTORY` <a name="org.cdk8s.plus22.HostPathVolumeType.DIRECTORY"></a>
...
#### `FILE_OR_CREATE` <a name="org.cdk8s.plus22.HostPathVolumeType.FILE_OR_CREATE"></a>
...
#### `FILE` <a name="org.cdk8s.plus22.HostPathVolumeType.FILE"></a>
...
#### `SOCKET` <a name="org.cdk8s.plus22.HostPathVolumeType.SOCKET"></a>
...
#### `CHAR_DEVICE` <a name="org.cdk8s.plus22.HostPathVolumeType.CHAR_DEVICE"></a>
...
#### `BLOCK_DEVICE` <a name="org.cdk8s.plus22.HostPathVolumeType.BLOCK_DEVICE"></a>
...
#### `DENY` <a name="org.cdk8s.plus22.NetworkPolicyTrafficDefault.DENY"></a>
...
#### `ALLOW` <a name="org.cdk8s.plus22.NetworkPolicyTrafficDefault.ALLOW"></a>
...
#### `TCP` <a name="org.cdk8s.plus22.NetworkProtocol.TCP"></a>
...
#### `UDP` <a name="org.cdk8s.plus22.NetworkProtocol.UDP"></a>
...
#### `SCTP` <a name="org.cdk8s.plus22.NetworkProtocol.SCTP"></a>
...
#### `POD` <a name="org.cdk8s.plus22.PodConnectionsIsolation.POD"></a>
...
#### `PEER` <a name="org.cdk8s.plus22.PodConnectionsIsolation.PEER"></a>
...
#### `NO_SCHEDULE` <a name="org.cdk8s.plus22.TaintEffect.NO_SCHEDULE"></a>
...
#### `PREFER_NO_SCHEDULE` <a name="org.cdk8s.plus22.TaintEffect.PREFER_NO_SCHEDULE"></a>
...
#### `NO_EXECUTE` <a name="org.cdk8s.plus22.TaintEffect.NO_EXECUTE"></a>
