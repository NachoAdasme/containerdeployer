...
const coverage_1 = require("../lib/commands/coverage");
...
function main() {
    const argv = yargs
        ...
        const result = (0, lib_1.translateTypeScript)(await makeFileSource(args.FILE ?? '-', 'stdin.ts'), makeVisitor(args));
        ...
        const packageJsonPath = (await fs_1.promises.stat(args.PACKAGE)).isDirectory()
        ...
        return fs_1.promises.writeFile(packageJsonPath, JSON.stringify(packageJson, null, 2));
    }))
        .demandCommand()
        .help()
...
async function makeFileSource(fileName, stdinName) {
    ...
    return {
        contents: await fs_1.promises.readFile(fileName, { encoding: 'utf-8' }),
        fileName: fileName,
    };
}
...
main();
//# sourceMappingURL=jsii-rosetta.js.map